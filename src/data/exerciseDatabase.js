...
export const EXERCISE_DB = [
  ...
  { id:53, name:'Сгибание ног лёжа в тренажёре',        muscle:'Ноги',  place:'gym',  equipment:'Тренажёр',    eff:'good', swap:'hamstring',     type:'isolation' },
  ...
  { id:232,name:'Тяга бёдрами в рычажном тренажёре', muscle:'Ноги', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'glutes', type:'compound' },
  ...
  // ═══════════ РЫЧАЖНЫЕ ТРЕНАЖЁРЫ И НОВИЧКОВЫЕ ДВИЖЕНИЯ ═══════════
  { id:291,name:'Тяга с опорой грудью в рычажном тренажёре', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_horiz', type:'compound' },
  { id:292,name:'Тяга с опорой грудью нейтральным хватом', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_horiz', type:'compound' },
  { id:293,name:'Независимая тяга сверху в рычажном тренажёре', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_vert', type:'compound' },
  { id:294,name:'Независимая тяга сверху обратным хватом', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_vert', type:'compound' },
  { id:295,name:'Горизонтальная рычажная тяга одной рукой', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_horiz', type:'compound' },
  { id:296,name:'Горизонтальная рычажная тяга двумя руками', muscle:'Спина', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'back_horiz', type:'compound' },
  { id:297,name:'Рычажный жим от груди', muscle:'Грудь', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'chest_press', type:'compound' },
  { id:298,name:'Рычажный жим от груди на наклонной скамье', muscle:'Грудь', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'chest_press', type:'compound' },
  { id:299,name:'Рычажный жим на плечи', muscle:'Плечи', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'shoulder_press', type:'compound' },
  { id:300,name:'Рычажный жим ногами', muscle:'Ноги', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'quad', type:'compound' },
  { id:301,name:'Рычажная тяга на заднюю дельту', muscle:'Плечи', place:'gym', equipment:'Рычажный тренажёр', eff:'good', swap:'rear_delt', type:'isolation' },
  { id:302,name:'Пуловер в верхнем блоке прямыми руками', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_vert', type:'isolation' },
  { id:303,name:'Тяга верхнего блока одной рукой', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_vert', type:'compound' },
  { id:304,name:'Тяга нижнего блока одной рукой к поясу', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_horiz', type:'compound' },
  { id:305,name:'Тяга нижнего блока узким нейтральным хватом', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_horiz', type:'compound' },
  { id:306,name:'Тяга верхнего блока широким нейтральным хватом', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_vert', type:'compound' },
  { id:307,name:'Тяга верхнего блока с прямой рукоятью', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_vert', type:'compound' },
  { id:308,name:'Тяга к лицу в блоке (face pull)', muscle:'Плечи', place:'gym', equipment:'Блок', eff:'good', swap:'rear_delt', type:'isolation' },
  { id:309,name:'Сгибание ноги стоя в тренажёре', muscle:'Ноги', place:'gym', equipment:'Тренажёр', eff:'good', swap:'hamstring', type:'isolation' },
  { id:310,name:'Разгибание бедра назад в тренажёре', muscle:'Ноги', place:'gym', equipment:'Тренажёр', eff:'good', swap:'glutes', type:'isolation' },
  { id:311,name:'Отведение бедра в тренажёре стоя', muscle:'Ноги', place:'gym', equipment:'Тренажёр', eff:'good', swap:'abductor', type:'isolation' },
  { id:312,name:'Болгарские выпады в Смите', muscle:'Ноги', place:'gym', equipment:'Тренажёр Смита', eff:'good', swap:'quad', type:'compound' },
  { id:313,name:'Присед к скамье', muscle:'Ноги', place:'both', equipment:'Скамья', eff:'base', swap:'quad', type:'compound' },
  { id:314,name:'Степ-ап на платформу без веса', muscle:'Ноги', place:'both', equipment:'Степ-платформа', eff:'base', swap:'quad', type:'compound' },
  { id:315,name:'Подъём на икры в жиме ногами', muscle:'Ноги', place:'gym', equipment:'Тренажёр', eff:'good', swap:'calves', type:'isolation' },
  { id:316,name:'Pallof press в блоке', muscle:'Кор', place:'gym', equipment:'Блок', eff:'good', swap:'anti_rotation', type:'isolation' },
  { id:317,name:'Dead bug (мёртвый жук)', muscle:'Кор', place:'home', equipment:'Своё тело', eff:'base', swap:'core_static', type:'isolation' },
  { id:318,name:'Обратные скручивания', muscle:'Кор', place:'both', equipment:'Своё тело', eff:'good', swap:'abs', type:'isolation' },
  { id:319,name:'Планка с опорой на возвышение', muscle:'Кор', place:'both', equipment:'Скамья', eff:'base', swap:'core_static', type:'isolation' },
  { id:320,name:'Жим в тренажёре одной рукой', muscle:'Грудь', place:'gym', equipment:'Тренажёр', eff:'good', swap:'chest_press', type:'compound' },
  { id:321,name:'Тяга верхнего блока нейтральным хватом', muscle:'Спина', place:'gym', equipment:'Блок', eff:'good', swap:'back_vert', type:'compound' },
]
